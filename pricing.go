...
// context is cancelled, the server ends the stream ([ErrStreamEnded]), or no
// data arrives within the stall timeout ([ErrStreamStalled], see
// [WithStreamStallTimeout]). Callers should reconnect after either error.
//
